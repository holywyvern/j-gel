...
public class HighPassFilter extends GaussianFilter {
	...
	/**
	 * Instantiates a new high pass filter.
	 */
    ...
    /* (non-Javadoc)
     * @see com.jhlabs.image.GaussianFilter#filter(java.awt.image.BufferedImage, java.awt.image.BufferedImage)
     */
	...
	/* (non-Javadoc)
	 * @see com.jhlabs.image.GaussianFilter#toString()
	 */
