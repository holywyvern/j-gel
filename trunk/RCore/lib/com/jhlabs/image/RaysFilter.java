...
public class RaysFilter extends MotionBlurOp {
    ...
    /**
	 * Instantiates a new rays filter.
	 */
    public RaysFilter() {
	}
    ...
    /* (non-Javadoc)
     * @see com.jhlabs.image.MotionBlurOp#filter(java.awt.image.BufferedImage, java.awt.image.BufferedImage)
     */
	...
	/* (non-Javadoc)
	 * @see com.jhlabs.image.MotionBlurOp#toString()
	 */
